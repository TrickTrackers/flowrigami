...
export const DECISION_BORDER_COLOR = '#ECDEF1';
export const DECISION_BORDER_COLOR_HOVER = '#DABEF1';
export const DECISION_BORDER_COLOR_ACTIVE = '#D0BEFE';
export const DECISION_BACKGROUND_COLOR = '#FAE8BE';

export const MACHINE_BORDER_COLOR = '#ECD5A1';
export const MACHINE_BORDER_COLOR_HOVER = '#DABA71';
export const MACHINE_BORDER_COLOR_ACTIVE = '#D0B26E';
export const MACHINE_BACKGROUND_COLOR = '#FAE8BE';
