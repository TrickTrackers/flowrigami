...
export function getMessageShapeParams({ x, y }: CoordinatePoint) {
  return {
    x,
    y,
...
export function getSelectionMessageShapeParams({ x, y }: CoordinatePoint) {
  return {
    x,
    y,
...
export function getPreviewMessageShapeParams({ x, y }: CoordinatePoint) {
  return {
    x: x,
    y: y,
