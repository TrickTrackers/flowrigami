...
import CanvasMachine from '@app/flow/graphics/canvas/shapes/CanvasMachine';
import Store from '@app/flow/store/Store';


export default class DecisionNode extends Node {
  public name = UmlNodes.MachineNode;
  ...
  private preview: CanvasMachine;
  private selection: CanvasMachine;
  private rhombus: CanvasMachine;
  ...
  constructor(canvas: HTMLCanvasElement, htmlLayer: HTMLElement, params: CoordinatePoint) {
    ...
    this.rhombus = new CanvasMachine(canvas, htmlLayer, styles, getRhombusParams(params));
    this.selection = new CanvasMachine(canvas, htmlLayer, SHAPE_SELECTION_STYLE, getSelectionRhombusParams(params));
    this.preview = new CanvasMachine(canvas, htmlLayer, previewStyles, getPreviewRhombusParams(params));
